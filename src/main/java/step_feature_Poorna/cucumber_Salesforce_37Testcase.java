...
public class cucumber_Salesforce_37Testcase extends Base_Test_Poorna {
	...
	public static User_Menu_Page_Poorna UMPP;
	...
	public void user_launches_login_page() {
		...
		UMPP= new User_Menu_Page_Poorna(driver);
	...
	public void user_clicks_on_the_user_menu_dropdown() throws IOException {
	...
	public void salesforce_forgot_password_page_should_be_displayed() throws IOException {
